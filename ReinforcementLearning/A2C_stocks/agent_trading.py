### NOTE: this is an incomplete implementation, abandoned on 14-Mar-2020
#import gym
import numpy as np
...
from nn import *
from rl_trader import MultiStockEnv, DQNAgent, get_data
...
if __name__ == "__main__":
    ...
    csvfile = "aapl_msi_sbux.csv"
    basepath = os.path.dirname(__file__)

    data = get_data(os.path.join(basepath,csvfile))
    env = MultiStockEnv
    agent = Agent(env)
